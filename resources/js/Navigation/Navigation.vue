<template>
    <nav class="fixed xl:flex top-0 h-[64px] container bg-white flex justify-between items-center z-[99]">
        ...
        <div class="flex items-center gap-4 xl:mr-[56px]">
            ...
            <div class="w-10 h-10 flex items-center justify-center rounded-full border border-dark_grey cursor-pointer transition-[background-color] xl:hover:bg-light_grey">
                <NotificationIcon />
            </div>
