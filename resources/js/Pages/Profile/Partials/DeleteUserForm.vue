<template>
    <div class="w-[calc(100%_-_32px)] max-w-[500px] mx-auto flex flex-col gap-4">
        <SubtitleComponent desc="Usuń konto" />
        <p>Po usunięciu konta wszystkie jego zasoby i dane zostaną trwale usunięte.
        </p>

        <Btn class="mt-6" btnType="danger" @click="deleteUser">Usuń</Btn>
    </div>
