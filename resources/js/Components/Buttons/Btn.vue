<template>
    <button class="button min-h-12 min-w-20 w-full py-2 rounded-lg flex items-center justify-center px-4 cursor-auto transition-colors cursor-pointer h-max"
            :class="[
                isLoader && 'pointer-events-none',
                disabled && 'opacity-[0.7] pointer-events-none',
                btnType==='primary' && 'border border-btn-primaryHover bg-btn-primary xl:hover:bg-btn-primaryHover',
